...
def _build_docx(docx_path, patient_name, patient_dob, prescriptions, today,
    ...
    # Bas de page: signature gauche + nom droite
    # Tableau sans style pour eviter les problemes LibreOffice
    bottom_tbl = doc.add_table(rows=1, cols=2)
    # Pas de style - compatible LibreOffice
    ...
    # Droite: nom + specialite aligne a droite
    _clear_cell(cell_right)
    dr_p = cell_right.paragraphs[0]
